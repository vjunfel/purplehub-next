            ...
            >
              ...
              <div className="relative overflow-hidden w-full h-full">
                <MenuCard
                  ...
                  width={300}
                  height={300}
                  className="transition-opacity duration-300 group-hover:opacity-60 w-full h-full object-cover"
                />
                <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-purple-800 bg-opacity-40 text-white text-xl">
                  View More
                </div>
              </div>

              <div className='flex flex-col items-end justify-start h-36 p-4'>
                <h3 className="w-full text-2xl text-start mb-2">{item.name}</h3>
